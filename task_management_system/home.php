...
<body>  
  <section id="section-1" class="animated slideInRight bg-faded">
    <p>To contribute to our discussions, join our chatroom community by clicking the link below!</p>
    </section>
<div class = "container">
  <header class="animated slideInLeft">          
    <h6 class="display 4" ><a href="./indexx.php?page=Lobby" class="button-link"> Open discussion room </a></h6>
  </header>
</div>
</body>
</html>
